...
def main():
    ...
    fig, ax = plt.subplots(figsize=(21 / 2.54, 12 / 2.54))
    ...
    output_png = os.path.join(figure_dir, "pv_generation_comparison.png")
    output_svg = os.path.join(figure_dir, "pv_generation_comparison.svg")
