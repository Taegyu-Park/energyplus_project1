...
figure_dir   = os.path.normpath(os.path.join(script_dir, "LLC_dcf"))
...
# ── Case 3 곡선 ─────────────────────────────────────────────────────
ax.plot(years, dcf3_M, color=C3, lw=dm.lw(1.5),
...
os.makedirs(figure_dir, exist_ok=True)
output_png = os.path.join(figure_dir, "fig10_payback_comparison.png")
output_svg = os.path.join(figure_dir, "fig10_payback_comparison.svg")
