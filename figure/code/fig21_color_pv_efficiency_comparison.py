...
def main():
    ...
    ax.set_title("1-Year Time Series of Daily PV Efficiency by Panel Color (Case 3: Kinetic, 14-day Moving Average)", fontsize=13, fontweight="bold", pad=12)
    ...
    # Save plots
    png_path = os.path.join(figure_dir, "fig21_color_pv_efficiency_comparison.png")
    svg_path = os.path.join(figure_dir, "fig21_color_pv_efficiency_comparison.svg")
    ...
    if os.path.exists(artifact_dir):
        artifact_png = os.path.join(artifact_dir, "fig21_color_pv_efficiency_comparison.png")
