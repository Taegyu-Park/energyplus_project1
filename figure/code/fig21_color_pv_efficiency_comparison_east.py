...
def main():
    ...
    cases = {
        "White": {
            "file": os.path.join(data_dir, "case3_white_east.csv"),
            "line_color": "#475569",     # Slate grey
            "efficiency": "10.51%"
        },
        "Light Gray Beige": {
            "file": os.path.join(data_dir, "case3_light_gray_beige_east.csv"),
            "line_color": "#78350f",     # Warm brown
            "efficiency": "14.71%"
        },
        "Terracotta": {
            "file": os.path.join(data_dir, "case3_terracotta_east.csv"),
    ...
    ax.set_title("1-Year Time Series of Daily PV Efficiency by Panel Color (Case 3: Kinetic, East Wall, 14-day Moving Average)", fontsize=13, fontweight="bold", pad=12)
    ...
    # Save plots
    png_path = os.path.join(figure_dir, "fig21_color_pv_efficiency_comparison_east.png")
    svg_path = os.path.join(figure_dir, "fig21_color_pv_efficiency_comparison_east.svg")
    ...
    if os.path.exists(artifact_dir):
        artifact_png = os.path.join(artifact_dir, "fig21_color_pv_efficiency_comparison_east.png")
